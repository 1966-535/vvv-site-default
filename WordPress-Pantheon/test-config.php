...
// contains strathcom specific config logic for prod and dev unification
if ( file_exists( dirname( __FILE__ ) . '/wp-strathcom.php' ) ) {
	require_once( dirname( __FILE__ ) . '/wp-strathcom.php' );
}
...
if ( file_exists( dirname( __FILE__ ) . '/wp-config-local.php' ) && ! isset( $_ENV['PANTHEON_ENVIRONMENT'] ) ) {
	...
	if ( isset( $_ENV['PANTHEON_ENVIRONMENT'] ) ) {
		...
		if ( in_array( $_ENV['PANTHEON_ENVIRONMENT'], array(
				'test',
				'live'
			), true ) && ! defined( 'DISALLOW_FILE_MODS' )
		) {
...
if ( ! defined( 'DOMAIN_CURRENT_SITE' ) ) {
	define( 'IS_LAUNCHED', false );
	if ( ( IS_LAUNCHED ) && ( ! isset( $_ENV['PANTHEON_ENVIRONMENT'] ) || 'live' === $_ENV['PANTHEON_ENVIRONMENT'] ) ) {
		define( 'DOMAIN_CURRENT_SITE', 'strathcomcms.com' );
	} else {
		define( 'DOMAIN_CURRENT_SITE', sprintf( '%s-strathcom-cms.pantheonsite.io', $_ENV['PANTHEON_ENVIRONMENT'] ) );
	}
}
...
/* Change cache folder to point to the uploads folder instead */
